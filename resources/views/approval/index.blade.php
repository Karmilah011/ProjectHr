                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="row">
                                        <div class="col mb-3">
                                          ...
                                          <input type="text" name="employe_id" disabled value="{{$value->employe_id}}" id="" cols="15" rows="5" class="form-control" placeholder="">
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col mb-3">
                                          <label for="nameBasic" class="form-label">Leave Type</label>
                                          <input type="text" name="leave_type_id" disabled value="{{$value->leave}}" id="nameBasic" class="form-control" placeholder="Enter Name">
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col mb-3">
                                          <label for="nameBasic" class="form-label">Reason for Leave</label>
                                          <textarea name="alsncuti" value="" id="" disabled cols="15" rows="5" class="form-control" placeholder="">{{$value->alasancuti}}</textarea>
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col mb-3">
                                          <label for="nameBasic" class="form-label">Start Date</label>
                                          <input type="date" name="tanggalmulai" disabled value="{{$value->tgl_mulai}}" id="nameBasic" class="form-control" placeholder="">
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col mb-3">
                                          <label for="nameBasic" class="form-label">Date of Completion</label>
                                          <input type="date" name="tanggalselesai" disabled value="{{$value->tgl_selesai}}" id="nameBasic" class="form-control" placeholder="">
                                        </div>
                                      </div>
                                    ...
                                    <form action="/approval/update/{{$value->id}}" method="post">
                                      ...
                                      @csrf
                                      @method('PUT')
                                        <button type="submit" name="approved" value="tolak" class="btn btn-outline-secondary" data-bs-dismiss="modal">
                                          Reject
                                        </button>
                                      </form>
